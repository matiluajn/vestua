...
cree la función isValide inicialice una pila dentro de ella, verificaremos si un elemento emergente de la pila es el símbolo de apertura correcto para el símbolo de cierre actual,
Una forma de comprobarlo es almacenando los pares de símbolos de apertura y cierre. De esta manera, podemos verificar si el elemento emergente de la pila, la clave , coincide con el valor de esa clave, que será el símbolo de cierre del par.